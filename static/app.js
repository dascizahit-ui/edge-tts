...
rateSlider.addEventListener("input", () => updateSliderLabel(rateSlider, rateValue, "%"));
pitchSlider.addEventListener("input", () => updateSliderLabel(pitchSlider, pitchValue, "Hz"));
volumeSlider.addEventListener("input", () => updateSliderLabel(volumeSlider, volumeValue, "%"));
